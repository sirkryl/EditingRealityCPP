...
namespace InteractiveFusion
{
	...
	enum OpenGLControlEvent { ModelDataUpdated, CopyTemporaryInModelData, CopyTemporaryInNextStateModelData, ModelHighlightsUpdated, RemoveModelHighlights, RemoveModelData, ResizeOpenGLViewport, ResetModelData, UpdateSegmentation, UpdateHoleFilling, UpdateCutPlane, SetupCutPlaneMode };
